...
import static user.UserDashBoard.jPanel11;
...
//        setLocation(450,110);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (jTextField3.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please select a product", "Warnirng", 2);
        } else if (jTextField4.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Product quantity is required", "Warnirng", 2);
        } else {
            model = (DefaultTableModel) jTable2.getModel();
                ...
                if (!(qty <= 0)) {
                    ...
                    if (newQty != 0) {
                        if (!(newQty > qty)) {
                            ...
                            JOptionPane.showMessageDialog(this, "Not enough Stock", "Warnirng", 2);
                        }
                    } else {
                        JOptionPane.showMessageDialog(this, "Please increase the product quantity", "Warnirng", 2);
                    }
                } else {
                    JOptionPane.showMessageDialog(this, "Stock is empty", "Warnirng", 2);
                }

            } else {
                JOptionPane.showMessageDialog(this, "Product already purchased", "Warnirng", 2);
            }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        MessageFormat header = new MessageFormat("Recipt-->    "+ "Email : "+email+"    "+"Total:"+total);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (model.getRowCount() > 0) {
            ...
            JOptionPane.showMessageDialog(this, "You haven't purchased any product", "Warnirng", 2);
        }
    ...
    public void setDefault() {
        ...
        UserDashBoard.jLabel18.setForeground(textPrimaryColor);
